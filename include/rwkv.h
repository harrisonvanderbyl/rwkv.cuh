...
public:
    ...
    Tensor operator()(std::vector<std::vector<ulong>> input)
    {
        ...
        /*
        x:Tensor(1.0625, -1.40625, 0.177734, 1.61719, , ..., 0.0493164, 0.0917969, -0.0351562, -0.251953, shape=(1, 18, 2048))
        ln0x:Tensor(0.613518, -0.145479, 0.0847036, 0.0485158, , ..., 0.0761809, 0.104404, 0.0372387, -0.119472, shape=(1, 18, 2048))
        kr:Tensor(-0.026847, 0.10621, -0.0383704, -0.0128958, , ..., 0.0950571, 0.119706, -0.0195037, -0.199927, shape=(1, 18, 2048))
        Starting workers
        Started workers
        k:Tensor(-1.37855, 0.363212, 3.51745, -0.925283, , ..., 1.36666, -1.93608, -2.56865, -3.6306, shape=(1, 18, 2048))*/
    }
